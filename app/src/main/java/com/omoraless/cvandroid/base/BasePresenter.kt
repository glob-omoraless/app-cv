...
import com.omoraless.cvandroid.injection.component.DaggerPresenterInjector
import com.omoraless.cvandroid.injection.component.PresenterInjector
...
abstract class BasePresenter<out V : BaseView>(protected val view: V) {
    ...
    private fun inject() {
        when (this) {
            is CVPresenter -> injector.inject(this)
        }
    }
}